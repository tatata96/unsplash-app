...
Photos are passed down to Home to display them in a grid structure.</br>
...
Clicking a pagination button fires nextPage function,nextPage function makes a call to fecthPhotos in App.js to update images grid.</br>
